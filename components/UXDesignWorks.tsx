...
const caseStudies = [
    {
        title: "Calensort Web Application",
        brief: "Full app design",
    ...
    {
        title: "Daily'ish Food Recipe APP",
        brief: "Accessibility-first design",
        impact: "A fast, intuitive home experience that makes cooking decisions effortless.",
        skills: ["UX Audit", "Accessibility", "Journey Mapping", "Handoff"],
        accent: "#9c6ec8",
        number: "02",
        behanceUrl: "https://www.behance.net/gallery/164924931/Daily-Food-Recipe-App-UI-UX-Homepage-Screen",
        behanceId: "164924931",
    },
    {
        title: "Jewelry Website UI Design",
        brief: "Premium jewelry website experience",
        impact: "2Strengthens trust through visual clarity",
        skills: ["AI/UX", "Interaction Design", "A/B Testing", "Figma"],
        accent: "#6ec8a9",
        number: "03",
        behanceUrl: "https://www.behance.net/gallery/163791175/Jewelry-Website-UI-Design-UI-UX",
        behanceId: "163791175",
    },
    {
        title: "E-Commerce Homepage Responsive UX Design",
        brief: "High-conversion e-commerce homepage",
        impact: "Faster product exploration",
        skills: ["Design System", "Dark Mode", "Motion Design", "Dev Handoff"],
        accent: "#c86e9c",
        number: "04",
        behanceUrl: "https://www.behance.net/gallery/244887459/E-Commerce-Homepage-Responsive-UX-Design",
        behanceId: "244887459",
    },
];
